        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-4 g-pr-1--lg g-mb-30 g-mb-0--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/kingo-assets/Porojo/Vuvuzela.png" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/kingo-assets/Mjue Maarufu/Mjue maarufu.png" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-4 g-pl-1--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/kingo-assets/Kingo katuni/kiongozi wa watu!.png" alt="Image Description">
                        </figure>
