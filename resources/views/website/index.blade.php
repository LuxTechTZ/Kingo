                ...
                <div class="row g-mb-60">
                            ...
                            <div class="row">
                                    ...
                                    <article>
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            <img class="img-fluid w-100"
                                                src="https://kingo.s3-eu-west-1.amazonaws.com/dynamic-content/images/4578-20210407134706-454802.jpg"
                                                alt="Image Description">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="https://kingo.s3-eu-west-1.amazonaws.com/dynamic-content/images/large-5987-20210405100545-304418.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Best dessert recipes for breakfast which will make your
                                                    day</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="https://kingo.s3-eu-west-1.amazonaws.com/dynamic-content/images/small-5222-20210405000931-413090.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Stylish things to do, see and purchase only this week</a>
                                            </h3>
                            ...
                            <div class="row g-mb-60">
                                <div class="col-lg-6 g-mb-30 g-mb-0--lg">
                                    ...
                                    <article class="g-mb-30">
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            ...
                                            <figcaption class="g-pos-abs g-top-20 g-left-20">
                                                <a class="btn btn-xs u-btn-red text-uppercase rounded-0"
                                                    href="#!">DOMOKAYA</a>
                                            </figcaption>
                                        </figure>
                                        ...
                                        <h3 class="h4 g-mb-10">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Mwana wa Kondoo Kafufuka</a>
                                        </h3>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <article class="g-mb-30">
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            <img class="img-fluid w-100"
                                                src="https://kingo.s3-eu-west-1.amazonaws.com/dynamic-content/images/small-7703-20210402112420-211462.jpg"
                                                alt="Image Description">

                                            <figcaption class="g-pos-abs g-top-20 g-left-20">
                                                <a class="btn btn-xs u-btn-cyan text-uppercase rounded-0"
                                                    href="#!">DOMOKAYA</a>
                                            </figcaption>
                                        </figure>
                                        ...
                                        <h3 class="h4 g-mb-10">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Heri James aomba msamaha</a>
                                        </h3>
                            ...
                            <div class="col-lg-4 col-sm-6 g-mb-30">
                                <article>
                                    ...
                                    <h3 class="g-font-size-16 g-mb-10">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Fimbo
                                            2</a>
                                    </h3>
                                </article>
                            </div>
                    ...
                    <div class="col-lg-3">
                            ...
                            <ul class="list-unstyled">
                                <li class="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-12">
                                    <h4 class="h6">
                                        ...
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Wrapbootstrap Marketplace</a>
                                    </h4>
                                </li>
                                <li class="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-12">
                                    <h4 class="h6">
                                        <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-5"></i>
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Google Adwords &amp; Adsense</a>
                                    </h4>
                                </li>
                                <li class="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-12">
                                    <h4 class="h6">
                                        <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-5"></i>
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Web
                                            Design with UX/UI</a>
                                    </h4>
                                </li>
                                <li class="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-12">
                                ...
                                <li class="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-12">
                                    <h4 class="h6">
                                        <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-5"></i>
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Support Forum &amp; Community</a>
                                    </h4>
                                </li>
                                <li class="mb-0">
                                    <h4 class="h6">
                        ...
                        {{-- <div class="u-shadow-v25 u-bg-overlay g-bg-img-hero g-bg-white-gradient-opacity-v2--after g-py-40 g-px-20 g-mb-50"
                            style="background-image: url(assets/img-temp/500x600/img1.jpg);">
                            <div class="u-bg-overlay__inner text-center">
                                <div class="g-mb-40">
                                    <h2 class="g-color-white">Vancouver, BC</h2>
                                    <p class="g-color-white-opacity-0_8">Unit 25 Suite 3, 925 Prospect PI,<br>Beach
                                        Resort, 23001</p>
                                </div>
                                <div class="g-mb-30">
                                    <h3
                                        class="d-inline-block g-bg-primary-opacity-0_6 g-color-white g-font-weight-600 g-font-size-12 text-uppercase g-py-5 g-px-10">
                                        Phone number</h3>
                                    <span class="d-block g-color-white g-font-size-18">+01 (0) 333 444 55</span>
                                </div>
                                <div class="input-group rounded">
                                    <input class="form-control g-brd-none g-font-size-13 g-px-13 g-py-11" type="email"
                            ...
                            <div class="g-mb-50">
                                {{-- <article class="g-pos-rel">
                                    <figure class="u-shadow-v25 g-bg-img-hero g-min-height-400"
                                        style="background-image: url(assets/img-temp/500x650/img2.jpg);"></figure>
                                    ...
                                    <span
                                        class="u-icon-v3 g-font-size-default g-bg-white g-color-black g-bg-gray-dark-v2--hover g-color-white--hover g-rounded-50x g-cursor-pointer g-absolute-centered">
                                        <i class="fa fa-play g-left-2"></i>
                                    </span>
                        ...
                        <div class="g-mb-60">
                            ...
                            <div class="row g-mb-30">
                                ...
                                <div class="col-md-5">
                                    <figure class="u-shadow-v25 g-pos-rel g-mb-20 g-mb-0--lg">
                                        <img class="img-fluid w-100"
                                            src="https://kingo.s3-eu-west-1.amazonaws.com/dynamic-content/images/small-2962-20210325095726-282046.jpg"
                                            alt="Image Description">

                                        <figcaption class="g-pos-abs g-top-20 g-left-20">
                                            <a class="btn btn-xs u-btn-darkpurple text-uppercase rounded-0"
                                                href="#!">DOMOKAYA</a>
                                        </figcaption>
                                    </figure>
                                </div>
