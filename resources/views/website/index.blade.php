                        ...
                        <a id="account-dropdown-invoker" class="media align-items-center float-right g-text-underline--none--hover" href="#!"
                           ...
                           data-dropdown-animation-out="fadeOut">
                            <div class="d-flex g-width-30 g-height-30 mr-2">
                                <img class="img-fluid rounded-circle" src="{{url('/')}}/assets-magazine/img-temp/100x100/img11.jpg" alt="Image Description">
                            </div>
                        ...
                        <ul class="navbar-nav g-font-weight-600">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            <article class="media g-mb-20">
                                                <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{url('/')}}/assets-main/img-temp/500x320/img1.jpg" alt="Image Description"></a>
                                                <div class="media-body">
                                                    <h3 class="h6">
                                            ...
                                            <article class="media g-mb-20">
                                                <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{url('/')}}/assets-main/img-temp/500x320/img2.jpg" alt="Image Description"></a>
                                                <div class="media-body">
                                                    <h3 class="h6">
                                            ...
                                            <article class="media g-mb-20">
                                                <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{url('/')}}/assets-main/img-temp/500x320/img3.jpg" alt="Image Description"></a>
                                                <div class="media-body">
                                                    <h3 class="h6">
                                        ...
                                        <div class="col-lg-4">
                                            <article>
                                                <figure class="g-pos-rel">
                                                    <img class="img-fluid w-100 g-mb-20" src="{{url('/')}}/assets-main/img-temp/900x600/img7.jpg" alt="Image Description">
                                                </figure>
                                        ...
                                        <div class="col-lg-4">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img1.jpg" alt="Image Description">
                                                </figure>
                            ...
                            <i class="icon-camera"></i>
                                        ...
                                        <div class="col-lg-4">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img2.jpg" alt="Image Description">
                                                </figure>
                                                <span class="g-pos-abs g-top-20 g-left-20">
                            ...
                            <i class="icon-camera"></i>
                                        ...
                                        <div class="col-lg-4">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img3.jpg" alt="Image Description">
                                                </figure>
                                                <span class="g-pos-abs g-top-20 g-left-20">
                                ...
                                <div class="hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-left-15 g-right-15 g-pa-30 g-mt-17 g-mt-7--lg--scrolling" aria-labelledby="mega-menu-label-6">
                                    <div class="row">
                                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img1.jpg" alt="Image Description">
                                                </figure>
                                                <span class="g-pos-abs g-top-20 g-left-20">
                            ...
                            <a class="btn btn-sm u-btn-black rounded-0" href="#!">July 06, 2016</a>
                                        ...
                                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img3.jpg" alt="Image Description">
                                                </figure>
                                                <span class="g-pos-abs g-top-20 g-left-20">
                            <a class="btn btn-sm u-btn-red rounded-0" href="#!">
                              <i class="icon-energy"></i>
                            ...
                            <a class="btn btn-sm u-btn-black rounded-0" href="#!">July 15, 2016</a>
                                        ...
                                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                            <article class="u-block-hover">
                                                <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                                                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-main/img-temp/500x320/img2.jpg" alt="Image Description">
                                                </figure>
                                                <span class="g-pos-abs g-top-20 g-left-20">
                            <a class="btn btn-sm u-btn-red rounded-0" href="#!">
                              <i class="icon-energy"></i>
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                <div class="col-lg-6 g-pr-1--lg g-mb-30 g-mb-2--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-magazine/img-temp/430x270/img1.jpg" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-6 g-pl-1--lg g-mb-30 g-mb-2--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{url('/')}}/assets-magazine/img-temp/430x270/img2.jpg" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-4 g-pr-1--lg g-mb-30 g-mb-0--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/assets-magazine/img-temp/400x270/img2.jpg" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/assets-magazine/img-temp/400x270/img1.jpg" alt="Image Description">
                        </figure>
                ...
                <div class="col-lg-4 g-pl-1--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--zoom-v1 img-fluid w-100" src="{{url('/')}}/assets-magazine/img-temp/400x270/img17.jpg" alt="Image Description">
                        </figure>
                ...
                <div class="js-carousel g-mx-minus-10"
                   ...
                   "settings": {
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 g-pos-rel mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img10.jpg" alt="Image Description">
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img5.jpg" alt="Image Description">
                            </figure>
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 g-pos-rel mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img6.jpg" alt="Image Description">
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img7.jpg" alt="Image Description">
                            </figure>
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img8.jpg" alt="Image Description">
                            </figure>
                    ...
                    <div class="js-slide g-px-10">
                        ...
                        <article class="media g-bg-white g-pa-10">
                            <figure class="d-flex g-width-70 g-height-70 mr-3">
                                <img class="img-fluid" src="{{url('/')}}/assets-magazine/img-temp/230x230/img9.jpg" alt="Image Description">
                            </figure>
                           ...
                           "slidesToShow": 1
                                ...
                                <div class="js-slide g-px-5">
                                    ...
                                    <figure class="u-block-hover g-pos-rel">
                                        <img class="img-fluid u-block-hover__main--zoom-v1 g-transition-0_5" src="{{url('/')}}/assets-magazine/img-temp/350x400/img3.jpg" alt="Image Description">
                                ...
                                <div class="js-slide g-px-5">
                                    <!-- Magazines -->
                                    <figure class="u-block-hover g-pos-rel">
                                        <img class="img-fluid u-block-hover__main--zoom-v1 g-transition-0_5" src="{{url('/')}}/assets-magazine/img-temp/350x400/img2.jpg" alt="Image Description">
                                        <figcaption class="g-color-white">
                                            <div class="g-pos-abs g-top-0 g-left-0 g-pa-20">
                                ...
                                <div class="js-slide g-px-5">
                                    <!-- Magazines -->
                                    <figure class="u-block-hover g-pos-rel">
                                        <img class="img-fluid u-block-hover__main--zoom-v1 g-transition-0_5" src="{{url('/')}}/assets-magazine/img-temp/350x400/img1.jpg" alt="Image Description">
                                        <figcaption class="g-color-white">
                                            <div class="g-pos-abs g-top-0 g-left-0 g-pa-20">
                                ...
                                <div class="js-slide g-px-5">
                                    <!-- Magazines -->
                                    <figure class="u-block-hover g-pos-rel">
                                        <img class="img-fluid u-block-hover__main--zoom-v1 g-transition-0_5" src="{{url('/')}}/assets-magazine/img-temp/350x400/img4.jpg" alt="Image Description">
                                        <figcaption class="g-color-white">
                                            <div class="g-pos-abs g-top-0 g-left-0 g-pa-20">
