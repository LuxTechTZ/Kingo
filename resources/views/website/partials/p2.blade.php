...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6/multipage/blog-magazine/classic/bm-classic-single-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Feb 2021 07:48:56 GMT -->
<head>
    <!-- Title -->
              ...
              <article class="g-mb-60">
                ...
                <div class="g-font-size-16 g-line-height-1_8 g-mb-30">
                  <figure class="u-shadow-v25 g-mb-30">
                    <img class="img-fluid w-100" src="{{url('/')}}/assets-magazine/img-temp/900x600/img1.jpg" alt="Image Description">
                  </figure>
                  ...
                  <figure class="text-center text-md-left float-md-left g-pr-30--sm g-py-20 mb-0">
                    <img class="u-shadow-v25 img-fluid g-width-300" src="{{url('/')}}/assets-magazine/img-temp/500x650/img1.jpg" alt="Image Description">
                  ...
                  <figure class="text-center g-my-40">
                    <img class="u-shadow-v25 img-fluid" src="{{url('/')}}/assets-magazine/img-temp/430x270/img1.jpg" alt="Image Description">
                    <figcaption class="figure-caption g-font-size-12 g-color-gray-dark-v4 g-mt-5">
                      <em>A caption for the above image.</em>
                    </figcaption>
                  </figure>
                ...
                <div class="g-mb-60">
                  ...
                  <!-- Comment 1 -->
                  <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-20">
                    <img class="d-flex u-shadow-v25 g-width-50 g-height-50 rounded-circle g-mr-15" src="{{url('/')}}/assets-magazine/img-temp/100x100/img9.jpg" alt="Image Description">
                  ...
                  <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-ml-40 g-mb-20">
                    <img class="d-flex u-shadow-v25 g-width-50 g-height-50 rounded-circle g-mr-15" src="{{url('/')}}/assets-magazine/img-temp/100x100/img10.jpg" alt="Image Description">
                  ...
                  <!-- Comment 3 -->
                  <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-20">
                    <img class="d-flex u-shadow-v25 g-width-50 g-height-50 rounded-circle g-mr-15" src="{{url('/')}}/assets-magazine/img-temp/100x100/img11.jpg" alt="Image Description">
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6/multipage/blog-magazine/classic/bm-classic-single-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Feb 2021 07:48:59 GMT -->
</html>
